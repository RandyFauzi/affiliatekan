                    ...
                    <div class="space-y-2">
                        @foreach ($adminNavigationItems as $adminNavigationItem)
                            <a
                                ...
                                class="group flex items-center gap-3 rounded-2xl px-4 py-3 text-sm font-semibold transition-all duration-300 {{ $adminNavigationItem['active'] ? 'bg-orange-50 text-brandOrange' : 'text-slate-500 hover:bg-slate-50 hover:text-slate-800' }}"
                            >
